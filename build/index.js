                ...
                switch (request.params.name) {
                    ...
                    case 'create_post': {
                        ...
                        return createPost({
                            ...
                            authors: Array.isArray(authors) ? authors.filter((a) => typeof a === 'string') : undefined,
                    ...
                    case 'get_member': {
                        ...
                        return getMember({
                            id,
                            include: Array.isArray(include) ? include.filter((i) => typeof i === 'string' && ['labels', 'newsletters'].includes(i)) : undefined,
                        });
                    }
                    case 'search_members':
